...
class AppTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_team" do
    assert_difference('AppTeam.count') do
      post app_teams_url, params: { app_team: { added_by: @app_team.added_by, app_id: @app_team.app_id, business_id: @app_team.business_id, user_id: @app_team.user_id } }
    end
  ...
  test "should update app_team" do
    patch app_team_url(@app_team), params: { app_team: { added_by: @app_team.added_by, app_id: @app_team.app_id, business_id: @app_team.business_id, user_id: @app_team.user_id } }
