...
class AppPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_plan" do
    assert_difference('AppPlan.count') do
      post app_plans_url, params: { app_plan: { app_id: @app_plan.app_id, plan_name: @app_plan.plan_name, plan_price: @app_plan.plan_price, plan_trial_price: @app_plan.plan_trial_price, trial_days: @app_plan.trial_days } }
    end
  ...
  test "should update app_plan" do
    patch app_plan_url(@app_plan), params: { app_plan: { app_id: @app_plan.app_id, plan_name: @app_plan.plan_name, plan_price: @app_plan.plan_price, plan_trial_price: @app_plan.plan_trial_price, trial_days: @app_plan.trial_days } }
