...
class PlanDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create plan_datum' do
    assert_difference('PlanDatum.count') do
      post plan_data_url,
           params: { plan_datum: { app_id: @plan_datum.app_id, plan_id: @plan_datum.plan_id,
                                   plan_paying_users: @plan_datum.plan_paying_users, plan_total_users: @plan_datum.plan_total_users, plan_trial_users: @plan_datum.plan_trial_users } }
    end
  ...
  test 'should update plan_datum' do
    patch plan_datum_url(@plan_datum),
          params: { plan_datum: { app_id: @plan_datum.app_id, plan_id: @plan_datum.plan_id,
                                  plan_paying_users: @plan_datum.plan_paying_users, plan_total_users: @plan_datum.plan_total_users, plan_trial_users: @plan_datum.plan_trial_users } }
