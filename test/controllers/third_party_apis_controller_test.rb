...
class ThirdPartyApisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create third_party_api" do
    assert_difference('ThirdPartyApi.count') do
      post third_party_apis_url, params: { third_party_api: { api_key: @third_party_api.api_key, api_secret: @third_party_api.api_secret, platform_id: @third_party_api.platform_id, secondary_api_key: @third_party_api.secondary_api_key, secondary_api_secret: @third_party_api.secondary_api_secret } }
    end
  ...
  test "should update third_party_api" do
    patch third_party_api_url(@third_party_api), params: { third_party_api: { api_key: @third_party_api.api_key, api_secret: @third_party_api.api_secret, platform_id: @third_party_api.platform_id, secondary_api_key: @third_party_api.secondary_api_key, secondary_api_secret: @third_party_api.secondary_api_secret } }
