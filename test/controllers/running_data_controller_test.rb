...
class RunningDataControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create running_datum' do
    assert_difference('RunningDatum.count') do
      post running_data_url,
           params: { running_datum: { date: @running_datum.date, gross_paying_mrr: @running_datum.gross_paying_mrr,
                                      gross_paying_users: @running_datum.gross_paying_users, gross_trial_mrr: @running_datum.gross_trial_mrr, gross_trial_users: @running_datum.gross_trial_users } }
    end
  ...
  test 'should update running_datum' do
    patch running_datum_url(@running_datum),
          params: { running_datum: { date: @running_datum.date, gross_paying_mrr: @running_datum.gross_paying_mrr,
                                     gross_paying_users: @running_datum.gross_paying_users, gross_trial_mrr: @running_datum.gross_trial_mrr, gross_trial_users: @running_datum.gross_trial_users } }
