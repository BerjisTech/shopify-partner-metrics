...
class RunningDataEndpointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create running_data_endpoint" do
    assert_difference('RunningDataEndpoint.count') do
      post running_data_endpoints_url, params: { running_data_endpoint: { app_id: @running_data_endpoint.app_id, data_rounds: @running_data_endpoint.data_rounds, endpoint: @running_data_endpoint.endpoint } }
    end
  ...
  test "should update running_data_endpoint" do
    patch running_data_endpoint_url(@running_data_endpoint), params: { running_data_endpoint: { app_id: @running_data_endpoint.app_id, data_rounds: @running_data_endpoint.data_rounds, endpoint: @running_data_endpoint.endpoint } }
