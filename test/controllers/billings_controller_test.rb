...
class BillingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create billing' do
    assert_difference('Billing.count') do
      post billings_url,
           params: { billing: { amount: @billing.amount, app_id: @billing.app_id, business_id: @billing.business_id,
                                plan_id: @billing.plan_id, user_id: @billing.user_id } }
    end
