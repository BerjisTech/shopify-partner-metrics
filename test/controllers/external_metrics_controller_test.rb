...
class ExternalMetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create external_metric" do
    assert_difference('ExternalMetric.count') do
      post external_metrics_url, params: { external_metric: { app_id: @external_metric.app_id, arpu: @external_metric.arpu, gross: @external_metric.gross, lost_users: @external_metric.lost_users, mrr_chrun: @external_metric.mrr_chrun, net: @external_metric.net, new_users: @external_metric.new_users, paying_users: @external_metric.paying_users, trial: @external_metric.trial, trial_users: @external_metric.trial_users, user_churn: @external_metric.user_churn } }
    end
  ...
  test "should update external_metric" do
    patch external_metric_url(@external_metric), params: { external_metric: { app_id: @external_metric.app_id, arpu: @external_metric.arpu, gross: @external_metric.gross, lost_users: @external_metric.lost_users, mrr_chrun: @external_metric.mrr_chrun, net: @external_metric.net, new_users: @external_metric.new_users, paying_users: @external_metric.paying_users, trial: @external_metric.trial, trial_users: @external_metric.trial_users, user_churn: @external_metric.user_churn } }
