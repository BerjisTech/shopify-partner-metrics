...
class RunningMetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create running_metric' do
    assert_difference('RunningMetric.count') do
      post running_metrics_url,
           params: { running_metric: { app_id: @running_metric.app_id, arpu: @running_metric.arpu, gross: @running_metric.gross,
                                       mrr_chrun: @running_metric.mrr_chrun, paying_users: @running_metric.paying_users, trial: @running_metric.trial, trial_users: @running_metric.trial_users, user_churn: @running_metric.user_churn } }
    end
  ...
  test 'should update running_metric' do
    patch running_metric_url(@running_metric),
          params: { running_metric: { app_id: @running_metric.app_id, arpu: @running_metric.arpu, gross: @running_metric.gross,
                                      mrr_chrun: @running_metric.mrr_chrun, paying_users: @running_metric.paying_users, trial: @running_metric.trial, trial_users: @running_metric.trial_users, user_churn: @running_metric.user_churn } }
